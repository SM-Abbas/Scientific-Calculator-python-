__author__ = "ABBAS PRODUCTIONS"

__copyright__ = "Copyright (C) 2021 ABBAS"
...
print("                   Author : Mohammmad Suheb Abbas          ")
...
print("   # To make chnages to the app , mail to suhebabbasm@gmail.com     ")
...
root.title("SCIENTIFIC CALCULATOR ~ ABBAS PRODUCTIONS  V~1.0 ")
...
button1=Button(root,text="1",padx=44,pady=20,command=lambda:click(1),bg="black",fg="white",font=('Segoe UI',20))

button2=Button(root,text="2",padx=40,pady=20,command=lambda:click(2),bg="black",fg="white",font=('Segoe UI',20))

button3=Button(root,text="3",padx=36,pady=20,command=lambda:click(3),bg="black",fg="white",font=('Segoe UI',20))

button4=Button(root,text="4",padx=44,pady=20,command=lambda:click(4),bg="black",fg="white",font=('Segoe UI',20))

button5=Button(root,text="5",padx=40,pady=20,command=lambda:click(5),bg="black",fg="white",font=('Segoe UI',20))

button6=Button(root,text="6",padx=36,pady=20,command=lambda:click(6),bg="black",fg="white",font=('Segoe UI',20))

button7=Button(root,text="7",padx=44,pady=20,command=lambda:click(7),bg="black",fg="white",font=('Segoe UI',20))
